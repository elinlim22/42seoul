...
void execute_commands(char **argv, int temporary_file_descriptor, char **environment_variables)
{
    int i = 0;
    int fd[2];
...
int main(int argc, char **argv, char **environment_variables)
{
    ...
    (void)argc;
    execute_commands(argv, temporary_file_descriptor, environment_variables);
    return 0;
}
